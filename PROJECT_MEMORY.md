...
- Git delivery: implementation pushed to GitHub `origin/main` at commit `1804948` (`fix: harden home Wi-Fi fallback and startup updates`); this memory update is the follow-up delivery note.
