...
- GitHub delivery completed: source `main` is synchronized at commit `2a6ad9694dcb152d52dee65c9346f588c1d97783`; release `v0.8.16+79` keeps the updater-compatible asset `lovely-camp-v0.8.16.apk` with SHA-256 `C79BF1F5FA2575252F879B040AD759BB93E6F58FA4078D1BCD30C775C3BEA673`. Release notes contain only user-facing changes.
