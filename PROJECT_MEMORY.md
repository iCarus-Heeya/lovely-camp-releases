...
- Release status: source `main` was pushed to the official GitHub repository at commit `fcff6ab` (`https://github.com/iCarus-Heeya/lovely-camp-releases`). No `v0.9.1+88` GitHub Release/APK asset was uploaded in this round, so online update discovery remains unclaimed until a public asset is published.
